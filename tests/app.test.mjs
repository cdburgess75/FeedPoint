...
check('favicon + apple-touch-icon wired', icons.favicon && icons.touch === 'https://cdburgess75.github.io/FeedPoint/touch-icon-180-v12.png' && icons.iosTitle === 'FeedPoint', JSON.stringify(icons));
